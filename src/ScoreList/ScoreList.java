...
public class ScoreList {
    ...
    public void showList() {
        System.out.printf("%-6s", "课程名称");
        System.out.printf("%-6s", "学生姓名");
        System.out.printf("%-6s", "学生学号");
        System.out.printf("%-6s", "分数");
        System.out.print("\n");
        for (int i = 0; i < length; i++) {
            ...
            System.out.printf("%-10.1f", list[i].getScore());
            System.out.print("\n");
        }
    }
    ...
    public void getCourseScore() {
        ...
        System.out.printf("%-10.1f", max);
        System.out.printf("%-10s", "最低分");
        System.out.printf("%-10.1f", min);
        System.out.printf("%-10s", "平均分");
        System.out.printf("%-10.2f", sum / cnt);
        System.out.print("\n");
    }
